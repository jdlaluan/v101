    ...
    <div class="flex h-full w-full flex-1 flex-col gap-4 rounded-xl">
        <div class="grid auto-rows-min gap-4 md:grid-cols-3">
            <div class="relative mb-6 w-full">
                <flux:heading size="xl" level="1">{{ __('View Task') }}</flux:heading>
...
<x-layouts.app :title="__('Enrollment')">
    <div class="flex h-full w-full flex-1 flex-col gap-4 rounded-xl">
        <div class="grid auto-rows-min gap-4 md:grid-cols-3">
            <div class="relative mb-6 w-full">
                <flux:heading size="xl" level="1">{{ __('Enrollment') }}</flux:heading>
                <flux:subheading size="lg" class="mb-6">{{ __('Manage the user data modules.') }}</flux:subheading>
                <flux:separator variant="subtle" />
            </div>
        </div>
